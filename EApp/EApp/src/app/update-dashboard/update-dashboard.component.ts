...
export class UpdateDashboardComponent {
  ...
  constructor( private updateuser: AuthService, private router: Router, private route: ActivatedRoute, private toastr: ToastrService ) {
  ...
  hcouserUpdate(){
    ...
    (result) => {
      ...
      this.toastr.info("HCO information updated successfully");
